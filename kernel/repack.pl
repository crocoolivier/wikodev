...
sub repack_boot {
	...
	my $newramdisk = $header . $ramdisk;
        ...
        system ("dd if=header of=zImageMod");
        system ("dd if=$kernel of=zImageMod bs=512 seek=1"); 
	...
	if ( $^O eq "cygwin" ) {
		system ("./mkbootimg.exe --kernel zImageMod --ramdisk new-ramdisk-repack.cpio.gz -o $outfile");
	} else {
		system ("./mkbootimg --kernel zImageMod --ramdisk new-ramdisk-repack.cpio.gz -o $outfile");
	}
...
print "TAILLE : ".$length."\n";
        ...
        return pack('a4La32H*', "\x88\x16\x88\x58",512,"", "");
}
